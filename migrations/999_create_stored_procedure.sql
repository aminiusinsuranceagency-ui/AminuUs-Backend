...
RETURNS TABLE(company_id UUID, company_name VARCHAR(100)) AS $$
BEGIN
    RETURN QUERY
...
RETURNS TABLE(type_id UUID, type_name VARCHAR(100)) AS $$
BEGIN
    RETURN QUERY
...
-- ===========================================================
-- ANALYTICS STORED PROCEDURES CONVERTED TO POSTGRESQL
-- ===========================================================
...
-- ===========================================================
-- Analytics Stored Procedures - PostgreSQL Format
-- ===========================================================
